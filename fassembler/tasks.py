...
XXXPYPI = "http://localhost/simple/simple"
...
class VirtualEnv(Task):
    ...
    def iter_subtasks(self):
        ...
        if self.environ.config.has_option('general', 'find_links'):
            ...
            result.append(SetDistutilsValue('Add custom find_links locations',
        ...
        if self.environ.config.has_option('general', 'pypi_index_url'):
            ...
            result.append(SetDistutilsValue('Add custom index_url location',
