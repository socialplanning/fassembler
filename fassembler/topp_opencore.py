...
"""
    ...
    actions = [
        ...
        tasks.SaveURI(uri='http://{{config.host}}:{{config.port}}/openplans',
                      uri_template='http://{{config.host}}:{{config.port}}/VirtualHostBase/http/{HTTP_HOST}/openplans/projects/{project}/VirtualHostRoot',
                      path='/',
                      header_name='zope',
                      theme='not-main-site'),
        tasks.SaveURI(project_name='opencore_global',
                      uri='http://{{config.host}}:{{config.port}}/openplans',
                      uri_template='http://{{config.host}}:{{config.port}}/VirtualHostBase/http/{HTTP_HOST}/openplans/VirtualHostRoot',
                      path='/',
                      project_local=False,
                      header_name='zope',
                      theme='not-main-site')
